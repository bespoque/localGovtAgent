                    ...
                    <div className="flex items-start justify-start p-2 space-x-4">
                      <div className="flex-shrink-0 w-12">
                        {uploadErrors.length > 0 ? (
                          <span className="h-10 w-10 bg-emerald-100 text-white flex items-center justify-center rounded-full text-lg font-display font-bold">
                            <FiX
                              size={18}
                        ...
                        <div className="overflow-auto max-h-64">
                          {uploadErrors.length > 0 &&
                            uploadErrors.map((err, i) => (
                              <li className="text-emerald-500" key={i}>
                                {err}
                              </li>
                            ))}
                        </div>
            ...
            <div className="flex justify-center">
              <div className="flex">
                ...
                <Link legacyBehavior href="#">
                  <a className="flex overflow-hidden btn btn-default btn-outlined  mr-4 bg-transparent text-teal-500 hover:text-teal-700 border-teal-500 hover:border-teal-700">
                    User Guide
                  </a>
                </Link>
              </div>
