  ...
  const SubmitHandler = async (data) => {
    ...
    try {
      const res = await axios.put(
        `${url.BASE_URL}user/update-forgot-password`,
  ...
  return (
    <div className="w-96">
      <CenteredForm
        ...
        title="Please enter your new password to reset your account"
      >
        {successMsg !== null && (
          <>
        ...
        {errorMsg !== null && (
          <>
            <p className="p-2 shadow-md border-l-2 text-emerald-700 border-emerald-500">
              {errorMsg}
            </p>
          </>
        )}
              ...
              <div className="">
                <span>
                  <Link legacyBehavior href="/login">
                    <a className=" text-teal-700">Back to Login</a>
                  </Link>
                </span>
              </div>
            </div>
