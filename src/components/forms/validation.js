            ...
            <div className="flex flex-col w-full">
              {errors[item.name] && (
                <div className="mb-2" key={i}>
                  <Alert
                    color="bg-transparent border-emerald-500 text-emerald-500"
                    borderLeft
                    raised
                  >
                    {msg}
                    ...
                    <label className="flex items-center justify-start space-x-2">
                      <input
                        ...
                        className={`form-checkbox h-4 w-4 ${
                          errors[item.name] ? "text-emerald-500" : ""
                        }`}
                      />
                      <span
                        className={`${
              ...
              <div className="form-element">
                ...
                <select
                  ...
                  className={`form-select ${
                    errors[item.name] ? "border border-emerald-500" : ""
                  }`}
                >
                  {item.options.map((option, j) => (
              ...
              <div className="form-element">
                ...
                <input
                  ...
                  className={`form-input ${
                    errors[item.name] ? "border-emerald-500" : ""
                  }`}
                  placeholder={item.placeholder}
                />
                {!alerts && errors[item.name] && (
