...
const Apps = () => {
  const items = [
    ...
    {
      title: "Account",
      icon: <FiUser className="stroke-current text-xl text-teal-700" />,
    },
    {
      title: "Comments",
      icon: (
        <FiMessageSquare className="stroke-current text-xl text-teal-500" />
      ),
    },
    {
      title: "Settings",
    ...
    {
      title: "Maps",
      icon: <FiMapPin className="stroke-current text-xl text-emerald-500" />,
    },
    {
      title: "Twitter",
