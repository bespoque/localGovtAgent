  ...
  return (
    <div className="hidden lg:flex relative">
      <button
        ...
        <span
          className="absolute uppercase font-bold inline-flex text-center p-0 leading-none text-2xs h-4 w-4 inline-flex items-center justify-center rounded-full bg-teal-500 text-white"
