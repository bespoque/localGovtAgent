  ...
  return (
    <div className="w-full flex flex-col items-center justify-end mb-8 lg:mb-0">
      ...
      <div className="flex flex-row items-center justify-center h-10">
        ...
        <span className="text-3xl text-teal-500">{price}</span>
        <span className="text-gray-500">/mo</span>
      </div>
      <div className="flex flex-row w-full items-center justify-center mt-4">
        <button className="btn btn-lg btn-rounded bg-teal-500 hover:bg-teal-600 text-white">
          Sign up
        </button>
      </div>
    </div>
      ...
      <div className="flex flex-col mb-4 lg:flex-row">
        <div className="w-full lg:w-1/4 p-2">
          <PricingTable
            {...data[0]}
            icon={
              <FiActivity size={36} className="stroke-current text-teal-500" />
            }
          />
        </div>
        <div className="w-full lg:w-1/4 p-2">
          <PricingTable
            {...data[1]}
            icon={
              <FiBarChart2 size={36} className="stroke-current text-teal-500" />
            }
          />
        </div>
        <div className="w-full lg:w-1/4 p-2">
          <PricingTable
            {...data[2]}
            icon={
              <FiUsers size={36} className="stroke-current text-teal-500" />
            }
          />
        </div>
        <div className="w-full lg:w-1/4 p-2">
          <PricingTable
            {...data[3]}
            icon={<FiBox size={36} className="stroke-current text-teal-500" />}
          />
        </div>
      </div>
    </>
