...
const Index = () => {
  ...
  const duePayment = data?.data?.data
  ...
  //       (data) => data.rev_sub === "2200080010012010102"
  //     );
  ...
  const tabsWithIcons = [
    {
      ...
      content: (
        <>
          <Paymentable recentRemittance={duePayment?.all_remittances} />
          {/* <CustomPagination
    ...
    },
    {
      ...
      content: (
        <>
          <Paymentable recentRemittance={duePayment?.monthly_remittance_paye} />
          {/* <CustomPagination
    ...
    },
    {
      ...
      content: (
        <>
          <Paymentable recentRemittance={duePayment?.withholding} />
          {/* <CustomPagination
    ...
    },
    {
      ...
      content: (
        <>
          <Paymentable recentRemittance={duePayment?.other_remittances} />
          {/* <CustomPagination
  ...
  return (
    <>
      ...
      <SectionTitle title="Payment" subtitle="Due Payment" />
      <Widget>
