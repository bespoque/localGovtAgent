  ...
  useEffect(() => {
    if (router && router.query) {
      ...
      const fetchPost = () => {
        setIsFetching(true);
        axios
          .get(`${url.BASE_URL}web/noauth/invoice/${paymentID}`, {
            headers: {
                ...
                <div className="mt-3">
                  ...
                  <div className="grid grid-cols-6 gap-2">
                    ...
                    <div className="col-span-3">
                      <p className="font-bold">
                        {" "}
                        {`Payment for ${colData.revenueCode}`}{" "}
                      </p>
                      <small>{colData.revenueItem}</small>
                    </div>
                  </div>
                  <div className="grid grid-cols-6 gap-2">
                    <p>DETAILS:</p>
                  ...
                  <div className="grid grid-cols-6 gap-2">
                    ...
                    <p className="font-bold">
                      {" "}
                      {colData?.bank || colData?.paymentMethod}{" "}
                    </p>
                  </div>
                  <div className="grid grid-cols-6 gap-2">
                    <p>AGENCY:</p>
