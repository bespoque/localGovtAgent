...
const StatsCard = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:space-x-4">
      ...
      <div className=" p-4 rounded-xl shadow-lg flex justify-between">
        <div className="flex flex-col justify-between">
          <p className=" text-xs text-gray-400">Total Amount Completed</p>
          <h5 className="font-bold text-gray-500 text-lg">
      ...
      <div className=" p-4 rounded-xl shadow-lg flex justify-between">
        <div className="flex flex-col justify-between">
          <p className=" text-xs text-gray-400">Total Amount Pending</p>
          <h5 className="font-bold text-gray-500 text-lg">
