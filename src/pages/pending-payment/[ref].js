...
const Index = () => {
  ...
  const paymentStatus = async (ref) => {
    ...
    try {
      const response = await axios.post(
        `${url.BASE_URL}user/user-check-payment-status`,
        { payment_ref: ref }
      );
  ...
  return (
    <>
      ...
      {data?.length > 0 &&
        data.map((da) => (
          <div key={da.idpymt}>
            <SectionTitle subtitle="Due Payment" />
            <Widget>
              <div className="py-10  w-full">
                <div className="flex flex-row items-center justify-between mb-4">
                  <div className=" font-bold text-base tracking-wider flex flex-row items-center justify-start whitespace-nowrap">
                    {/* <KgirsLogo /> */}
                    <a
                      href="/payment/pending-invoice"
                ...
                <div className="lg:flex justify-between w-full">
                  ...
                  <div className="w-full">
                    <div className="uppercase lg:w-4/5 w-full px-2">
                      ...
                      {/* {da.payment_details.payment_channel == "Bank" || 
                      da.payment_details.payment_channel == "USSD"  && (<button
                ...
                <div className="modal show">
                  <div className="relative w-auto lg:my-4 mx-auto lg:w-1/2 max-w-sm">
                    <div className="bg-white text-gray-900 border-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-700 border-0 rounded-lg shadow-lg relative flex flex-col w-full outline-none">
                      ...
                      <div className="flex justify-between items-center px-8 mt-4">
                        <div className="">
                          <SubmitButton onClick={() => setOpenBank(false)}>
                            Close
                          </SubmitButton>
                        </div>
