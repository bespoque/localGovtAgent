...
const Index = () => {
  ...
  const downloadPDF = () => {
    ...
    html2canvas(element).then((canvas) => {
      ...
      setIsLoading(false);
      pdf.save(`${data.body.payment_details.payment_reference} receipt.pdf`);
    });
  };
                        ...
                        <tbody className="p-3">
                          <tr className="text-sm font-medium text-gray-900">
                            <td className="whitespace-nowrap py-4 pl-3 pr-5">
                              {data.body.payment_details.payment_channel}
                            </td>
                            <td className="whitespace-nowrap py-4 pr-5">
                              {data.body.payment_details.payment_reference}
                            </td>
                            <td className="whitespace-nowrap py-4 pr-5">
                              {dateformat(
                                data.body.payment_details.creation_date,
                                "ddd, dS mmm, yyyy"
                              )}
                            </td>
                            <td className="whitespace-nowrap py-4 pr-5">
                            ...
                            <td className="whitespace-nowrap py-4 pr-5">
                              &#8358;
                              {formatNumber(data.body.payment_details.amount)}
                            </td>
                          </tr>
                        </tbody>
                      </table>
